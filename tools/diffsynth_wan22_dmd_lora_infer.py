#!/usr/bin/env python3
"""Run DiffSynth Wan2.2-TI2V-5B inference with the exported DMD LoRA."""
...
def main():
    ...
    pipe.load_lora(pipe.dit, str(args.dmd_lora_path), alpha=args.lora_alpha)
    ...
    if args.timing_json is not None:
        ...
        timing = {
            ...
            "dmd_lora_path": str(args.dmd_lora_path),
            "prompt": args.prompt,
            "seed": args.seed,
            "height": args.height,
            "width": args.width,
