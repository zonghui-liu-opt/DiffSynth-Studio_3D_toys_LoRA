...
OUTPUT_ROOT=${OUTPUT_ROOT:-./models/train/Wan2.2-TI2V-5B_figurine360_lora}
NUM_GPUS=${NUM_GPUS:-4}
HEIGHT=${HEIGHT:-480}
WIDTH=${WIDTH:-832}
...
# T1 branch A: two-column metadata loads only video; --extra_inputs input_image falls back to video[0].
